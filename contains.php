...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            // $sql = "SELECT * FROM `contains` WHERE ORDER_NO in (SELECT MAX(ORDER_NO) FROM `orders`";
            $sql = "SELECT * FROM contains
            WHERE ORDER_NO in (SELECT ORDER_NO FROM orders WHERE ORDER_NO = (SELECT MAX(ORDER_NO) FROM orders))";
